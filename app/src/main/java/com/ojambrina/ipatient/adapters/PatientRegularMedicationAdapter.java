...
public class PatientRegularMedicationAdapter extends RecyclerView.Adapter<PatientRegularMedicationAdapter.ViewHolder> {
    ...
    public PatientRegularMedicationAdapter(Context context, Patient patient, String clinicName, String patientName, FirebaseFirestore firebaseFirestore) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        holder.layoutRemove.setOnClickListener(v -> {
            ...
            patient.setRegularMedication(list);
