...
public class PatientMedicExaminationAdapter extends RecyclerView.Adapter<PatientMedicExaminationAdapter.ViewHolder> {
    ...
    public PatientMedicExaminationAdapter(Context context, Patient patient, String clinicName, String patientName, FirebaseFirestore firebaseFirestore) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        holder.layoutRemove.setOnClickListener(v -> {
            ...
            patient.setMedicExamination(list);
