...
public class PatientSurgicalOperationsAdapter extends RecyclerView.Adapter<PatientSurgicalOperationsAdapter.ViewHolder> {
    ...
    public PatientSurgicalOperationsAdapter(Context context, Patient patient, String clinicName, String patientName, FirebaseFirestore firebaseFirestore) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        holder.layoutRemove.setOnClickListener(v -> {
            ...
            patient.setSurgicalOperations(list);
